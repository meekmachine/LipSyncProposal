...
% Their design involves careful application of {metaphorical design.}
% %\subsection{Metaphoric Design in Human-Computer Interaction}
% %\subsubsection{Origins and Application of Metaphoric Design in Embodied Agents}
% Metaphorical design is a foundational concept in human-computer interaction (HCI) that involves using familiar symbols and concepts to represent complex digital functions, thereby making them more accessible and intuitive for users. The concept has its roots in cognitive science and design theory, with significant contributions from pioneers like Donald Norman. Norman's work, particularly in \textit{The Design of Everyday Things} \cite{norman1988design}, which emphasized how metaphors can make technology more user-friendly by leveraging users' existing knowledge and experiences. Alan Kay and his team at Xerox PARC extended these ideas into practical applications, such as the graphical user interface (GUI), where metaphors like the "desktop," "folders," and "trash can" became standard features of user interfaces \cite{kay1977personal}.

% \subsection{Development of Socially Intelligent Agents (SIAs)}
