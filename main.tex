...
\begin{titlepage}
    ...
    \vspace{5cm}
    \includegraphics[width=.5\textwidth]{logo.png} \\[1cm] % First image
    \vspace{0cm}
    \vfill
    {\Large \today}
\end{titlepage}
...
% THIS IS DUPLICATED IN SECTION 3.4 
